...
if __name__ == '__main__':
    ...
    imuPubGlobal = rospy.Publisher('~myo_imu_global', Imu, queue_size=1)
    ...
    velTwistPub = rospy.Publisher('~vel_twist_imu', TwistStamped, queue_size=1)
    accTwistPubGlobal = rospy.Publisher('~acc_twist_global', TwistStamped, queue_size=1)
    velTwistPubGlobal = rospy.Publisher('~vel_twist_global', TwistStamped, queue_size=1)
